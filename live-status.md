...
- `/health` did not respond within 120 seconds from local check.
- `/demo/start` did not respond within 120 seconds from local check.

This usually means the Render service is still building, sleeping too long, or failed to start.
